...
Public Class frmCertificado
    ...
    Sub LansarNoExcel()
        ...
        If txtCliente1.Text = "UNILEVER VIETNAM INTERNACIONAL" And lblCodigox.Text = "3007000081" Then
            Documento_xlsx = Excell.Workbooks.Open("f:\Receb.Mat.Prima\Banco_Dados\ProjetoCertificado\Modelos_Certificados\3007000075.xlsx", , ReadOnly:=True)
        Else
        ...
        If txtCliente1.Text = "UNILEVER VIETNAM INTERNACIONAL" And lblCodigox.Text = "3007000081" Then
            ...
            'pb.Value += 1
        ElseIf lblCodigox.Text = "3007000081" Or lblCodigox.Text = "3007000082" Or lblCodigox.Text = "3007000095" Then
            'pb.Value += 1
...
ErrHandler:
    ...
    Sub SalvarPDF()
        ...
        'pb.Value += 1
        If (txtCliente1.Text = "UNILEVER VIETNAM INTERNACIONAL" And lblCodigox.Text = "3007000081") Or (lblCodigox.Text = "3007000075") Then
        ...
        Try
            ...
            If btCriar.Text = "Aplicar" Then
                ...
                For i = 1 To verRB Step 1
                    ...
                    ElseIf lblCodigo1.Text = "3007000081" Or lblCodigo1.Text = "3007000082" Or lblCodigox.Text = "3007000095" Then
            ...
            ElseIf btEmail.Text = "...Email" Then
                ...
                For i = 1 To verRB Step 1
                    If (txtCliente1.Text = "UNILEVER VIETNAM INTERNACIONAL" And lblCodigox.Text = "3007000081") Then
                        OutlookMessage.Attachments.Add("f:\RECEB.MAT.PRIMA\Banco_Dados\ProjetoCertificado\Certificados_Salvos\" & x & "-" & lblCodigox.Text & ".pdf")
                    ElseIf lblCodigo1.Text = "3007000081" Or lblCodigo1.Text = "3007000082" Or lblCodigox.Text = "3007000095" Then
            ...
            ElseIf btAlterarIndividual.Text = "Aplicar" Then
                If (txtCliente1.Text = "UNILEVER VIETNAM INTERNACIONAL" And lblCodigox.Text = "3007000081") Then
                    OutlookMessage.Attachments.Add("f:\RECEB.MAT.PRIMA\Banco_Dados\ProjetoCertificado\Certificados_Salvos\" & idIndividual & "-" & lblCodigox.Text & ".pdf")
                ElseIf lblCodigo1.Text = "3007000081" Or lblCodigo1.Text = "3007000082" Or lblCodigox.Text = "3007000095" Then
            ...
            ElseIf btEmailIndividual.Text = "...Email" Then
                If (txtCliente1.Text = "UNILEVER VIETNAM INTERNACIONAL" And lblCodigox.Text = "3007000081") Then
                    OutlookMessage.Attachments.Add("f:\RECEB.MAT.PRIMA\Banco_Dados\ProjetoCertificado\Certificados_Salvos\" & idReal & "-" & lblCodigox.Text & ".pdf")
                ElseIf lblCodigo1.Text = "3007000081" Or lblCodigo1.Text = "3007000082" Or lblCodigox.Text = "3007000095" Then
