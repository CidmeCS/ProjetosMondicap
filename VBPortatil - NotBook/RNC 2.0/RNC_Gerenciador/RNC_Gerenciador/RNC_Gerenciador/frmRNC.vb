...
Imports RNC_Gerenciador.Module1
Public Class frmRNC
    ...
    Sub AlterarCarregar2()
        Try
            ...
            If dsPRINT.Tables("tblRNC").Rows(0)("OP_Retrabalho") Is DBNull.Value Then
                txtOPRetrabalho.Clear()
            Else
                txtOPRetrabalho.Text = dsPRINT.Tables("tblRNC").Rows(0)("OP_Retrabalho")
            End If
    ...
    Private Sub AlterarCarregar()
        Try
            ...
            Try
                If dsPRINT.Tables("tblRNC").Rows(0)("Disposicao") = "Sem Disposição" Then
                    txtQTReprovado1.Text = ""
                    txtQTAprovado1.Text = ""
                ElseIf dsPRINT.Tables("tblRNC").Rows(0)("Disposicao") = "Retrabalhar" Then
                    rbRT1.Checked = True
                    If dsPRINT.Tables("tblRNC").Rows(0)("QT_ReprovadoR") Is DBNull.Value Then
                        txtQTReprovado1.Text = ""
                        txtQTAprovado1.Text = ""
                    Else
                        txtQTReprovado1.Text = dsPRINT.Tables("tblRNC").Rows(0)("QT_ReprovadoR")
                        txtQTAprovado1.Text = dsPRINT.Tables("tblRNC").Rows(0)("QT_AprovadoR")
                    End If
                ElseIf dsPRINT.Tables("tblRNC").Rows(0)("Disposicao") = "Refugar" Then
                    rbRF1.Checked = True
                Else
                    rbLC1.Checked = True
                End If
            ...
            If dtPrint.Rows.Count >= 2 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(1)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado2.Text = ""
                        txtQTAprovado2.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(1)("Disposicao") = "Retrabalhar" Then
                        rbRT2.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(1)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado2.Text = ""
                            txtQTAprovado2.Text = ""
                        Else
                            txtQTReprovado2.Text = dsPRINT.Tables("tblRNC").Rows(1)("QT_ReprovadoR")
                            txtQTAprovado2.Text = dsPRINT.Tables("tblRNC").Rows(1)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(1)("Disposicao") = "Refugar" Then
                        rbRF2.Checked = True
                    Else
                        rbLC2.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 3 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(2)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado3.Text = ""
                        txtQTAprovado3.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(2)("Disposicao") = "Retrabalhar" Then
                        rbRT3.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(2)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado3.Text = ""
                            txtQTAprovado3.Text = ""
                        Else
                            txtQTReprovado3.Text = dsPRINT.Tables("tblRNC").Rows(2)("QT_ReprovadoR")
                            txtQTAprovado3.Text = dsPRINT.Tables("tblRNC").Rows(2)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(2)("Disposicao") = "Refugar" Then
                        rbRF3.Checked = True
                    Else
                        rbLC3.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 4 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(3)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado4.Text = ""
                        txtQTAprovado4.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(3)("Disposicao") = "Retrabalhar" Then
                        rbRT4.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(3)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado4.Text = ""
                            txtQTAprovado4.Text = ""
                        Else
                            txtQTReprovado4.Text = dsPRINT.Tables("tblRNC").Rows(3)("QT_ReprovadoR")
                            txtQTAprovado4.Text = dsPRINT.Tables("tblRNC").Rows(3)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(3)("Disposicao") = "Refugar" Then
                        rbRF4.Checked = True
                    Else
                        rbLC4.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 5 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(4)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado5.Text = ""
                        txtQTAprovado5.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(4)("Disposicao") = "Retrabalhar" Then
                        rbRT5.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(4)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado5.Text = ""
                            txtQTAprovado5.Text = ""
                        Else
                            txtQTReprovado5.Text = dsPRINT.Tables("tblRNC").Rows(4)("QT_ReprovadoR")
                            txtQTAprovado5.Text = dsPRINT.Tables("tblRNC").Rows(4)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(4)("Disposicao") = "Refugar" Then
                        rbRF5.Checked = True
                    Else
                        rbLC5.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 6 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(5)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado6.Text = ""
                        txtQTAprovado6.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(5)("Disposicao") = "Retrabalhar" Then
                        rbRT6.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(5)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado6.Text = ""
                            txtQTAprovado6.Text = ""
                        Else
                            txtQTReprovado6.Text = dsPRINT.Tables("tblRNC").Rows(5)("QT_ReprovadoR")
                            txtQTAprovado6.Text = dsPRINT.Tables("tblRNC").Rows(5)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(5)("Disposicao") = "Refugar" Then
                        rbRF6.Checked = True
                    Else
                        rbLC6.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 7 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(6)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado7.Text = ""
                        txtQTAprovado7.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(6)("Disposicao") = "Retrabalhar" Then
                        rbRT7.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(6)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado7.Text = ""
                            txtQTAprovado7.Text = ""
                        Else
                            txtQTReprovado7.Text = dsPRINT.Tables("tblRNC").Rows(6)("QT_ReprovadoR")
                            txtQTAprovado7.Text = dsPRINT.Tables("tblRNC").Rows(6)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(6)("Disposicao") = "Refugar" Then
                        rbRF7.Checked = True
                    Else
                        rbLC7.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 8 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(7)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado8.Text = ""
                        txtQTAprovado8.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(7)("Disposicao") = "Retrabalhar" Then
                        rbRT8.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(7)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado8.Text = ""
                            txtQTAprovado8.Text = ""
                        Else
                            txtQTReprovado8.Text = dsPRINT.Tables("tblRNC").Rows(7)("QT_ReprovadoR")
                            txtQTAprovado8.Text = dsPRINT.Tables("tblRNC").Rows(7)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(7)("Disposicao") = "Refugar" Then
                        rbRF8.Checked = True
                    Else
                        rbLC8.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count >= 9 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(8)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado9.Text = ""
                        txtQTAprovado9.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(8)("Disposicao") = "Retrabalhar" Then
                        rbRT9.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(8)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado9.Text = ""
                            txtQTAprovado9.Text = ""
                        Else
                            txtQTReprovado9.Text = dsPRINT.Tables("tblRNC").Rows(8)("QT_ReprovadoR")
                            txtQTAprovado9.Text = dsPRINT.Tables("tblRNC").Rows(8)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(8)("Disposicao") = "Refugar" Then
                        rbRF9.Checked = True
                    Else
                        rbLC9.Checked = True
                    End If
            ...
            If dtPrint.Rows.Count = 10 Then
                ...
                Try
                    If dsPRINT.Tables("tblRNC").Rows(9)("Disposicao") = "Sem Disposição" Then
                        txtQTReprovado10.Text = ""
                        txtQTAprovado10.Text = ""
                    ElseIf dsPRINT.Tables("tblRNC").Rows(9)("Disposicao") = "Retrabalhar" Then
                        rbRT10.Checked = True
                        If dsPRINT.Tables("tblRNC").Rows(9)("QT_ReprovadoR") Is DBNull.Value Then
                            txtQTReprovado10.Text = ""
                            txtQTAprovado10.Text = ""
                        Else
                            txtQTReprovado10.Text = dsPRINT.Tables("tblRNC").Rows(9)("QT_ReprovadoR")
                            txtQTAprovado10.Text = dsPRINT.Tables("tblRNC").Rows(9)("QT_AprovadoR")
                        End If
                    ElseIf dsPRINT.Tables("tblRNC").Rows(9)("Disposicao") = "Refugar" Then
                        rbRF10.Checked = True
                    Else
                        rbLC10.Checked = True
                    End If
...
ErrHandler:
    ...
    Sub ImprimirRNC()
        ...
        If btInserir.Text = "Aplicar" Then
            ...
            'Descricao.Value = txtDescricaoRNC1.Text & ", " & txtDescricaoRNC2.Text & ", " & txtDescricaoRNC3.Text & ", " & txtDescricaoRNC4.Text & ", " & txtDescricaoRNC5.Text & ", " & txtDescricaoRNC6.Text & ", " & txtDescricaoRNC7.Text & ", " & txtDescricaoRNC8.Text & ", " & txtDescricaoRNC9.Text & ", " & txtDescricaoRNC10.Text
        ...
        ElseIf btImprimir.Text = "Imprimir..." Or btAlterar.Text = "Aplicar" Or btEmail.Text = "Email..." Then
            '7º Abrindo o excel
            Excell.Visible = False
            '8º Salvando a Planilha
            Documento_xlsx.Save()
...
ErrHandler:
        ...
        'MsgBox(Err.Description & vbCrLf & Err.Number & vbCrLf & Err.Source, vbCritical, "Erro 862 ")
        Resume ExitHere
    ...
    Private Sub btExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) 'Handles btExport.Click
        ...
        Dim _conn As String = ("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=F:\Receb.Mat.Prima\Banco_Dados\Gerenciamento de RNC 2013 - INTERNO.xlsx;Extended Properties=Excel 8.0")
        ...
        '3º Abrir o arquivo Excel
        Documento_xlsx = Excell.Workbooks.Open("F:\Receb.Mat.Prima\Banco_Dados\Gerenciamento de RNC 2013 - INTERNO.xlsx")
