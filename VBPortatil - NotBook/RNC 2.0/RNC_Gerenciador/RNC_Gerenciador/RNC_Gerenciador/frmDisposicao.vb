    ...
    Private Sub AlterarCarregar()
        Try
            ...
            ElseIf (dsPRINT.Tables("tblRNC").Rows(0)("Disposicao")) = "Retrabalhar" Then
                rbRT1.Checked = True
            ElseIf (dsPRINT.Tables("tblRNC").Rows(0)("Disposicao")) = "Liberado Condicional" Then
                rbLC1.Checked = True
            ...
            If dtPrint.Rows.Count >= 2 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(1)("Disposicao")) = "Retrabalhar" Then
                    rbRT2.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(1)("Disposicao")) = "Liberado Condicional" Then
                    rbLC2.Checked = True
            ...
            If dtPrint.Rows.Count >= 3 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(2)("Disposicao")) = "Retrabalhar" Then
                    rbRT3.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(2)("Disposicao")) = "Liberado Condicional" Then
                    rbLC3.Checked = True
            ...
            If dtPrint.Rows.Count >= 4 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(3)("Disposicao")) = "Retrabalhar" Then
                    rbRT4.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(3)("Disposicao")) = "Liberado Condicional" Then
                    rbLC4.Checked = True
            ...
            If dtPrint.Rows.Count >= 5 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(4)("Disposicao")) = "Retrabalhar" Then
                    rbRT5.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(4)("Disposicao")) = "Liberado Condicional" Then
                    rbLC5.Checked = True
            ...
            If dtPrint.Rows.Count >= 6 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(5)("Disposicao")) = "Retrabalhar" Then
                    rbRT6.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(5)("Disposicao")) = "Liberado Condicional" Then
                    rbLC6.Checked = True
            ...
            If dtPrint.Rows.Count >= 7 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(6)("Disposicao")) = "Retrabalhar" Then
                    rbRT7.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(6)("Disposicao")) = "Liberado Condicional" Then
                    rbLC7.Checked = True
            ...
            If dtPrint.Rows.Count >= 8 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(7)("Disposicao")) = "Retrabalhar" Then
                    rbRT8.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(7)("Disposicao")) = "Liberado Condicional" Then
                    rbLC8.Checked = True
            ...
            If dtPrint.Rows.Count >= 9 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(8)("Disposicao")) = "Retrabalhar" Then
                    rbRT9.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(8)("Disposicao")) = "Liberado Condicional" Then
                    rbLC9.Checked = True
            ...
            If dtPrint.Rows.Count = 10 Then
                ...
                ElseIf (dsPRINT.Tables("tblRNC").Rows(9)("Disposicao")) = "Retrabalhar" Then
                    rbRT10.Checked = True
                ElseIf (dsPRINT.Tables("tblRNC").Rows(9)("Disposicao")) = "Liberado Condicional" Then
                    rbLC10.Checked = True
