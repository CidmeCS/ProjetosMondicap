...
Public Class frmPecasVolume
    ...
    Private Sub frmPecasVolume_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Sub TesteAbertoPecasVolume()
        ...
        RNC_RE = Test("C:\Users\Cid\Documents\Projetos\BancoDados\RNC_PecasVolume.accdb")
        If RNC_RE = True Then
    ...
    Private Sub SetorChanged(sender As System.Object, e As System.EventArgs) Handles txtPecasVolume.LostFocus
        Try
